...
class TangentNode(api.CatenaNode):
    """
    A node that applies a tangent wave, either as a generator or as a remap of
    an input.
    """
    ...
    def process(
        ...
        """
        Apply a tangent wave remap to an input modifier, or generate a directional
