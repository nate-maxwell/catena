...
from catena.toolbars.action_sub_bars.subgraph import SubgraphToolbar
...
class EditorActionToolbar(QtWrappers.Toolbar):
    ...
    def build(self) -> None:
        ...
        switcher.add_toolbar("Modifier", ModifierToolbar(self))
        switcher.add_toolbar("Subgraph", SubgraphToolbar(self))
        switcher.add_toolbar("Transform", TransformToolbar(self))
