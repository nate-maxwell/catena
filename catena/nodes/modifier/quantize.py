...
class QuantizeProcessor(ProcessorNode):
    """A headless processor that pixelates an image by quantizing UV coordinates."""
...
class QuantizeNode(CatenaNode):
    ...
    def process(
        ...
        self._processor.factor = self.get_field_value("factor")
