...
from catena.application.preferences.general import GeneralPreferencesMenu
from catena.application.preferences.graph import GraphPreferencesMenu
from catena.application.preferences.layout import LayoutPreferencesMenu
