...
from catena.application.panes.obj_viewer import obj_viewer
from catena.application.panes.obj_viewer import obj_widget
from catena.application.panes.pane import DockablePane
from catena.application.panes.pane import PaneConfig
