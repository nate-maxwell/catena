...
from catena.application.about import about
from catena.application import shortcuts
from catena.application import namespace
from catena.application.preferences import menu as preferences_menu

if TYPE_CHECKING:
    from catena.application.client import CatenaEditor
